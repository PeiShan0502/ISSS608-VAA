...
In this hands-on exercise, we will visualise and analyse text data using R.
...
![](images/clipboard-2201125171.png)
...
The wordcloud below is plotted by using [**ggwordcloud**](https://lepennec.github.io/ggwordcloud/) package. The code chunk is as follows:
...
-   [tf–idf](https://en.wikipedia.org/wiki/Tf%E2%80%93idf), short for term frequency–inverse document frequency, is a numerical statistic that is intended to reflect how important a word is to a document in a collection of [corpus](https://en.wikipedia.org/wiki/Text_corpus).
    ...
    ![](images/clipboard-3778433588.png)
...
![](images/clipboard-255771010.png)
