...
<p style="color:red;"> Note to self: find out how to do panel tabset here</p>
...
In this section, we are going to use a ggplot2 extension called [**patchwork**](https://patchwork.data-imaginist.com/) which is <p style="color:red;"> specially designed for combining separate ggplot2 graphs into a single figure</p>.
