...
We install and load **sf**, **tmap** and **tidyverse** packages into R environment:
...
We plot a choropleth map showing the distribution of non-functional water points by LGA:
...
We plot a choropleth map showing the distribution of percentage functional water point by LGA:
