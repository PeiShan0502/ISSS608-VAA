...
We aggregate Sales and Budgeted Sales at the Product level:
...
It is important to note that a requirement of gtExtras functions is that they require you to pass data.frame with list columns. In view of this, the code chunk below will be used to convert the report data.frame into list columns.
...
By default the pagesize is 10. In the code chunk below, the argument `defaultPageSize` is used to change the default setting.
