...
When we cleaned the nodes data, we removed some of the nodes?? so we have to do this now. left join, umatched = "drop" so that excess ones from mc3_nodes will be left out.
