...
Advantage of using R over Python is that R already has base statistical packages, e.g., can just use hist() to plot histogram once ggplot package is loaded.
